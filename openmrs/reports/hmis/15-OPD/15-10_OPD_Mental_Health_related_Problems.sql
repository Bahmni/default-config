...
FROM
    ...
    WHERE
        icd10_code IN ('F03','F10','F20','F29','F31','F32','F40','F41','F42','F44','F48','F79','G40','G43','F99')
    ORDER BY FIELD(icd10_code, 'F03','F10','F20','F29','F31','F32','F40','F41','F42','F44','F48','F79','G40','G43','F99')) c
        LEFT OUTER JOIN
    (SELECT 
        concept_full_name,
