...
FROM
    ...
    WHERE
        icd10_code IN ('L70' , 'B07', 'L81.1', 'L50', 'L30.9', 'L65', 'L80','E70.3','B00','B02','L53.9','L01.0','L02','L02.0','L02.9','L43','B86','L81.5','L40','L04')
    ORDER BY FIELD(icd10_code, 'B05' , 'A36', 'A37', 'A33', 'A35', 'A16', 'G83', 'B06', 'B26', 'B01', 'B16')) c
        LEFT OUTER JOIN
    (SELECT 
        concept_full_name,
