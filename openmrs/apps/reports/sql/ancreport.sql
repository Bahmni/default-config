...
select concat(coalesce(given_name,''),' ', coalesce(middle_name,'') ,' ',coalesce(family_name,'') ) as 'Full Names', value as 'Unique ART No.' , tMobileNumber.mobile as 'Telephone Number' ,tUniqueART.Age as 'Age', tOccupation.Occupation,
tRetestingDate.Retesting as 'HIV Retesting for ART initiation?' ,  tARTStartDate.ARTStartDate as 'ART Start Date',
...
tSwitchedSecondlineRegimen.secondlineregimenchanged as '2nd: Substitution drug code'
 from (
