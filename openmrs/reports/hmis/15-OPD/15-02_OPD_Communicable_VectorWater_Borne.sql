...
FROM
    ...
    WHERE
        icd10_code IN ('A86' , 'B74.9', 'B54', 'B50.9', 'B51.9', 'A90', 'B55.9', 'A01.0', 'A09', 'A06.9', 'A03.9','K52.9','A00.9','B82.9','R17','B15.9','B17.2','E86')
    ORDER BY FIELD(icd10_code, 'A86' , 'B74.9', 'B54', 'B50.9', 'B51.9', 'A90', 'B55.9', 'A01.0', 'A09', 'A06.9', 'A03.9','K52.9','A00.9','B82.9','R17','B15.9','B17.2','E86')) c
        LEFT OUTER JOIN
    (SELECT 
        concept_full_name,
