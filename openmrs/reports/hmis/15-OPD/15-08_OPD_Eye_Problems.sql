...
FROM
    ...
    WHERE
        icd10_code IN ('H10','A71','H26','H54','H52','H40','H53.5','H05.2','H00.0','H00.1','H11.0','E14.3†','H35','H02','H02.1','H26.1','H20','H35.3','H53.0','H50','H35.5','H53.6','C69.2')
    ORDER BY FIELD(icd10_code, 'H10','A71','H26','H54','H52','H40','H53.5','H05.2','H00.0','H00.1','H11.0','E14.3†','H35','H02','H02.1','H26.1','H20','H35.3','H53.0','H50','H35.5','H53.6','C69.2')) c
        LEFT OUTER JOIN
    (SELECT 
        concept_full_name,
