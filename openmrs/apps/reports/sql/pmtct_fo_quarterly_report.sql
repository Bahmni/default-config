select  @a:=@a+1 as 'Serial'  , date_of_birth as 'Date Of Birth', Sex , eid_number as 'HEI Number' , date_eid_sample_collected as 'Date EID sample collected' ,zerototwomonths as '0 - 2 months of age' ,
abovetwomonths as '2 - 12 months of age' , Outcomeat24months as 'Final outcome at 24 months of age' from(
...
(
select * from (
select  person_id, concept_id, obs_datetime , encounter_id , value_numeric as 'eid_number', voided from obs where concept_id =
...
(
select * from (
select  person_id, concept_id, obs_datetime as 'date_eid_sample_collected' , encounter_id , voided from obs where concept_id =
