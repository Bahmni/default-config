...
from
    ...
    from obs outcome_of_delivery_obs
        left outer join obs gestation_period_obs on outcome_of_delivery_obs.person_id = gestation_period_obs.person_id and  gestation_period_obs.concept_id = (select concept_id from concept_name where name = 'Delivery Note, Gestation period' and concept_name_type = 'FULLY_SPECIFIED')
    ...
    where
        ...
        and outcome_of_delivery_obs.obs_datetime between "#startDate#" and "#endDate#"
