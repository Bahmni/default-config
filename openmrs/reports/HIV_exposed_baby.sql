...
(select o.person_id,o.concept_full_name,o.value_coded from obs_view o
                    ...
                    (o.concept_full_name in ('HIVTC, HIV +ve diagnosis result within 2m','HIVTC, HIV +ve diagnosis result 2-9m','HIVTC, HIV +ve diagnosis result 9-18m','HIVTC, HIV +ve diagnosis result after 18m') and o.value_coded in (@positive,@negative))) and 
