...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ANPO, Heure de début d\'anesthésie","Heure de début d\'anesthésie",'Datetime','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ANPO, Heure de fin d\'anesthésie","Heure de fin d\'anesthésie",'Datetime','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ANPO, Type d'anesthésie réalisée","Type d'anesthésie réalisée",'Coded','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ANPO, Drogues spéciales utilisées pendant la chirurgie","Drogues spéciales utilisées pendant la chirurgie",'Text','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ANPO, Complication de l\'anesthésie","Complication de l\'anesthésie",'Coded','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ANPO, Description de la complication","Description de la complication",'Text','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ANPO, Transfuson sanguine","Transfuson sanguine",'Coded','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ANPO, Produit sanguin administré en per opératoire","Produit sanguin administré en per opératoire",'Coded','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ANPO, Nombre d\'unités administrées","Nombre d\'unités administrées",'Numeric','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ANPO, Réaction transfusionnelle per operatoire","Réaction transfusionnelle per operatoire",'Coded','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ANPO, Commentaires","Commentaires",'Text','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ANPO, Quantité de fluides reçue","Quantité de fluides reçue",'Numeric','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ANPO, Hemoglobine","Hemoglobine",'Numeric','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ANPO, Glycémie","Glycémie",'Numeric','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ANPO, Matériel présent","Matériel présent",'Coded','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ANPO, Notes d'anesthésie post opératoire","Notes d'anesthésie post opératoire",'Text','Misc',false);
...
INSERT INTO concept_description (concept_id,description,locale,creator,date_created,changed_by,date_changed,uuid)
VALUES
((select concept_id from concept_name where name = "ANPO, Drogues spéciales utilisées pendant la chirurgie" and concept_name_type = 'FULLY_SPECIFIED' and locale = 'fr' and voided = 0),'ex. Anti-hypertensives','fr',1,now(),NULL,NULL,uuid());

INSERT INTO concept_description (concept_id,description,locale,creator,date_created,changed_by,date_changed,uuid)
VALUES
((select concept_id from concept_name where name = "ANPO, Drogues spéciales utilisées pendant la chirurgie" and concept_name_type = 'FULLY_SPECIFIED' and locale = 'en' and voided = 0),'ex. Anti-hypertensives','en',1,now(),NULL,NULL,uuid());
