  ...
  (SELECT
   ...
   FROM visit
     ...
     left JOIN coded_obs_view ON coded_obs_view.person_id = person.person_id
                                  ...
                                  AND DATE(coded_obs_view.obs_datetime) BETWEEN CAST('#startDate#' AS DATE) AND CAST('#endDate#' AS DATE)
     ...
     left JOIN orders ON orders.patient_id = person.person_id
                          ...
                          AND DATE(orders.date_created) BETWEEN CAST('#startDate#' AS DATE) AND CAST('#endDate#' AS DATE)
