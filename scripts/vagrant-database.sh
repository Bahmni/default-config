...
run_in_vagrant -c "sudo chown jss:jss /packages/build/possible_config/migrations"
run_in_vagrant -c "sudo su - jss -c 'sudo cp -r /Project/possible-config/migrations/* /packages/build/possible_config/migrations/'"
