...
FROM
    ...
    WHERE
        icd10_code IN ('A30.9' , 'G03.9', 'B20', 'A54.0', 'N49.9', 'N89.8', 'N74', 'A54.3', 'N76.6', 'N50.8', 'A55','A53.9','J22','J06.9','J18.9','J15','J40','N39.9','J11','N99.9','N51*')
    ORDER BY FIELD(icd10_code, 'A30.9' , 'G03.9', 'B20', 'A54.0', 'N49.9', 'N89.8', 'N74', 'A54.3', 'N76.6', 'N50.8', 'A55','A53.9','J22','J06.9','J18.9','J15','J40','N39.9','J11','N99.9','N51*')) c
        LEFT OUTER JOIN
    (SELECT 
        concept_full_name,
