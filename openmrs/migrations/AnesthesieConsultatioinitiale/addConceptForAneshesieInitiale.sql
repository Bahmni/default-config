...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Date la consultation","Date la consultation",'Datetime','Question',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Antécédents médicaux","Antécédents médicaux",'Coded','Question',false);
...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Traitement en cours","Traitement en cours",'Text','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Autres antécédents médicaux","Autres antécédents médicaux",'Text','Question',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Le patient a-t-il des allergies connues a des médicaments ?","Le patient a-t-il des allergies connues a des médicaments ?",'Coded','Question',false);
...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Type de médicaments","Type de médicaments",'Text','Finding',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Antécédents anesthésiques","Antécédents anesthésiques",'Coded','Finding',false);
...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Spécifiez le nombre d\'anesthésies antérieures","Spécifiez le nombre d\'anesthésies antérieures",'Numeric','Finding',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Réaction indésirable à une anesthésie antérieure","Réaction indésirable à une anesthésie antérieure",'Coded','Finding',false);
...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Commentaires sur la réaction indésirable","Commentaires sur la réaction indésirable",'Text','Finding',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Antécédent de transfusion","Antécédent de transfusion",'Coded','Finding',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Y a t-il eu incident transfusionnel?","Y a t-il eu incident transfusionnel?",'Coded','Finding',false);
...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Mallampati, classe","Mallampati, classe",'Coded','Finding',false);
...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Ouverture de la bouche","Ouverture de la bouche",'Numeric','Finding',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Score d\'ASA","Score d\'ASA",'Coded','Finding',false);
...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Type d\'anesthésie prévue","Type d\'anesthésie prévue",'Coded','Finding',false);
...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Groupe sanguin","Groupe sanguin",'Coded','Misc',false);
...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"AB-","AB-",'N/A','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Hemogramme fait","Hemogramme fait",'Coded','Finding',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, taux d\'hémoglobine","taux d\'hémoglobine",'Numeric','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, taux de plaquettes","taux de plaquettes",'Numeric','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Bilan rénal fait","Bilan rénal fait",'Coded','Finding',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Créatininémie","Créatininémie",'Numeric','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Urée","Urée",'Numeric','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Ionogramme fait","Ionogramme fait",'Coded','Finding',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Kaliémie","Kaliémie",'Numeric','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Natrémie","Natrémie",'Numeric','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Résultat de l\'observation initial d'anesthésie","Résultat de l\'observation initial d'anesthésie",'Coded','Finding',false);
...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Résultat de l\'observation initial d'anesthésie, commentaires","Résultat de l\'observation initial d'anesthésie, commentaires",'text','Finding',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, J\'ai discuté les risques et bénéfices de l'anesthésie et ai répondu à toutes les questions?","J\'ai discuté les risques et bénéfices de l'anesthésie et ai répondu à toutes les questions?",'Coded','Question',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Prémédication donnée","Prémédication donnée",'Coded','Question',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Type de pré médication","Type de pré médication",'Coded','Question',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"Morphine","Morphine",'N/A','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"Autre","Autre",'N/A','Misc',false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"ACI, Heure de l'injection", "Heure de l'injection",'Datetime','Misc',false);

INSERT INTO concept_description (concept_id,description,locale,creator,date_created,changed_by,date_changed,uuid)
VALUES
((select concept_id from concept_name where name = "ACI, Type d\'anesthésie prévue" and concept_name_type = 'FULLY_SPECIFIED' and locale = 'fr' and voided = 0),'GA with intubation; GA with nothing or facial mask; GA with laryngeal mask; Spinal; Plexic or Troncular: Axillary/Femoral/Sciatic; Transverse Abdominal Plane Bloc; Other Regional Technique; Local Anaesthesia; Sedation; Inflitration by surgeon','fr',1,now(),NULL,NULL,uuid());
