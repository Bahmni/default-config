...
count(distinct(case when value_numeric is not null and age < 1 then pid end)) as 'Vl_Documented',
count(distinct(case when value_numeric >= 1000 and age < 1 then pid end)) as 'VL results (>= 1,000 copies/ml)',
count(distinct(case when value_numeric < 1000 and age < 1 then pid end)) as 'VL results (< 1,000 copies/ml)',
...
count(distinct(case when isBreastfeeding and sex = 'M' and value_numeric >= 1000 and age < 1 then pid end)) as 'Breastfeeding Women with VL result equal or above 1000'
from 
(
...
count(distinct(case when value_numeric is not null and age > 1 and age < 4 then pid end)) as 'Vl_Documented',
...
count(distinct(case when isBreastfeeding and sex = 'M' and  value_numeric >= 1000 and age > 1 and age < 4  then pid end)) as 'Breastfeeding Women with VL result equal or above 1000'
from 
(
...
count(distinct(case when value_numeric is not null and age > 5 and age < 9 then pid end)) as 'Vl_Documented',
...
count(distinct(case when isBreastfeeding and sex = 'M' and  value_numeric >= 1000 and age > 5 and age < 9  then pid end)) as 'Breastfeeding Women with VL result equal or above 1000'
from 
(
select person_id as pid, obs_datetime , value_numeric from obs where concept_id = 
(select concept_id from concept_name where name = 'VL Results' and concept_name_type = 'FULLY_SPECIFIED' and voided = 0) and voided = 0 
...
count(distinct(case when value_numeric is not null and age > 10 and age < 14 then pid end)) as 'Vl_Documented',
...
count(distinct(case when isBreastfeeding and sex = 'M' and  value_numeric >= 1000 and age > 10 and age < 14  then pid end)) as 'Breastfeeding Women with VL result equal or above 1000'
from 
(
select person_id as pid, obs_datetime , value_numeric from obs where concept_id = 
(select concept_id from concept_name where name = 'VL Results' and concept_name_type = 'FULLY_SPECIFIED' and voided = 0) and voided = 0 
...
count(distinct(case when value_numeric is not null and age > 15 and age < 19 then pid end)) as 'Vl_Documented',
...
count(distinct(case when isBreastfeeding and sex = 'M' and  value_numeric >= 1000 and age > 15 and age < 19  then pid end)) as 'Breastfeeding Women with VL result equal or above 1000'
from 
(
select person_id as pid, obs_datetime , value_numeric from obs where concept_id = 
(select concept_id from concept_name where name = 'VL Results' and concept_name_type = 'FULLY_SPECIFIED' and voided = 0) and voided = 0 
...
count(distinct(case when value_numeric is not null and age > 20 and age < 24 then pid end)) as 'Vl_Documented',
...
count(distinct(case when isBreastfeeding and sex = 'M' and  value_numeric >= 1000 and age > 20 and age < 24  then pid end)) as 'Breastfeeding Women with VL result equal or above 1000'
from 
(
select person_id as pid, obs_datetime , value_numeric from obs where concept_id = 
(select concept_id from concept_name where name = 'VL Results' and concept_name_type = 'FULLY_SPECIFIED' and voided = 0) and voided = 0 
...
count(distinct(case when value_numeric is not null and age > 25 and age < 29 then pid end)) as 'Vl_Documented',
...
count(distinct(case when isBreastfeeding and sex = 'M' and  value_numeric >= 1000 and age > 29 and age < 29  then pid end)) as 'Breastfeeding Women with VL result equal or above 1000'
from 
(
select person_id as pid, obs_datetime , value_numeric from obs where concept_id = 
(select concept_id from concept_name where name = 'VL Results' and concept_name_type = 'FULLY_SPECIFIED' and voided = 0) and voided = 0 
...
count(distinct(case when value_numeric is not null and age > 30 and age < 34 then pid end)) as 'Vl_Documented',
...
count(distinct(case when isBreastfeeding and sex = 'M' and  value_numeric >= 1000 and age > 30 and age < 34  then pid end)) as 'Breastfeeding Women with VL result equal or above 1000'
from 
(
select person_id as pid, obs_datetime , value_numeric from obs where concept_id = 
(select concept_id from concept_name where name = 'VL Results' and concept_name_type = 'FULLY_SPECIFIED' and voided = 0) and voided = 0 
...
count(distinct(case when value_numeric is not null and age > 35 and age < 39 then pid end)) as 'Vl_Documented',
...
count(distinct(case when isBreastfeeding and sex = 'M' and  value_numeric >= 1000 and age > 35 and age < 39  then pid end)) as 'Breastfeeding Women with VL result equal or above 1000'
from 
(
select person_id as pid, obs_datetime , value_numeric from obs where concept_id = 
(select concept_id from concept_name where name = 'VL Results' and concept_name_type = 'FULLY_SPECIFIED' and voided = 0) and voided = 0 
...
count(distinct(case when value_numeric is not null and age > 40 and age < 44 then pid end)) as 'Vl_Documented',
...
count(distinct(case when isBreastfeeding and sex = 'M' and  value_numeric >= 1000 and age > 40 and age < 44  then pid end)) as 'Breastfeeding Women with VL result equal or above 1000'
from 
(
select person_id as pid, obs_datetime , value_numeric from obs where concept_id = 
(select concept_id from concept_name where name = 'VL Results' and concept_name_type = 'FULLY_SPECIFIED' and voided = 0) and voided = 0 
...
count(distinct(case when value_numeric is not null and age > 45 and age < 49 then pid end)) as 'Vl_Documented',
...
count(distinct(case when isBreastfeeding and sex = 'M' and  value_numeric >= 1000 and age > 45 and age < 49  then pid end)) as 'Breastfeeding Women with VL result equal or above 1000'
from 
(
select person_id as pid, obs_datetime , value_numeric from obs where concept_id = 
(select concept_id from concept_name where name = 'VL Results' and concept_name_type = 'FULLY_SPECIFIED' and voided = 0) and voided = 0 
...
count(distinct(case when value_numeric is not null and age >= 50 then pid end)) as 'Vl_Documented',
...
count(distinct(case when isBreastfeeding and sex = 'M' and  value_numeric >= 1000 and age >=50 then pid end)) as 'Breastfeeding Women with VL result equal or above 1000'
from 
(
select person_id as pid, obs_datetime , value_numeric from obs where concept_id = 
(select concept_id from concept_name where name = 'VL Results' and concept_name_type = 'FULLY_SPECIFIED' and voided = 0) and voided = 0 
