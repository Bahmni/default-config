...
FROM
    ...
    WHERE
        ...
        'N43','N47','I84','N45','N41','R69')) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
...
ORDER BY FIELD(first_answers.icd10_code,'K27','K60.2','K60.3','K63.2','N20.0','N63','N61','N64.4','D17','L72.1','L05','J32','K37','K81','K80','K46',
        'N43','N47','I84','N45','N41','R69')
